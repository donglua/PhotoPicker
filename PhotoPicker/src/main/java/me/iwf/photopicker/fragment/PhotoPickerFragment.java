...
public class PhotoPickerFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getActivity() instanceof PhotoPickerActivity) {
            mediaStoreArgs
                    .putBoolean(EXTRA_SHOW_GIF, ((PhotoPickerActivity) getActivity()).isShowGif());
        }
    ...
    public void initMenuWithPreselectedPhotos() {
        ...
        if (selected_photos != null && selected_photos.size() > 0) {
            ...
            ((PhotoPickerActivity) getActivity()).getMenuDoneItem()
                    .setTitle(selected_photos.size() > 1 ? getString(R.string.done_with_count,
                            selected_photos.size(), maxCount) : getString(R.string.done));
        }
    }
}
